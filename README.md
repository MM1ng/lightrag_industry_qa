...
2026-07-30 Kimi K2.6 实测报告位于 `dist/industrial_pump_trust_gates_report_final.json`：50 题 Recall@5 `0.757143`、引用可追溯率 `0.958333`、无证据拒答率 `1.0`、最大引用数 `3`、文档路由准确率 `1.0`、成功率 `1.0`。
